---
title: "GPIO pinout"
description: "GPIO assignments, bus configurations, and connector pinouts for the ED1 board."
---
...
| MCP23009 GPIO | Coil | Driver       | Motor |
| ------------- | ---- | ------------ | ----- |
...
block-beta
    columns 3
    space UP["UP · GPIO4"] space
    LEFT["LEFT · GPIO2"] TFT["TFT Display"] RIGHT["RIGHT · GPIO27"]
    OK["OK · GPIO15"] space X["X · GPIO14"]
    space DOWN["DOWN · GPIO13"] space
```
